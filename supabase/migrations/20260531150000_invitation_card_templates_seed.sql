...
VALUES
  ('editorial-white-front','에디토리얼 화이트 전면','paper','front','modern_minimal',3,'basic',
  ...
  ('botanical-line-front','보태니컬 라인 전면','paper','front','natural_romantic',4,'basic',
  ...
  ('film-photo-front','필름 포토 전면','paper','front','cinematic_emotional',4,'photo',
  ...
  ('opera-lace-front','오페라 레이스 전면','paper','front','classic_maximal',5,'premium',
  ...
  ('clean-info-back','클린 인포 후면','paper','back','clean_practical',3,'basic',
  ...
  ('letter-botanical-back','레터 보태니컬 후면','paper','back','warm_letter',4,'basic',
   ARRAY['Gowun Batang','Pretendard'],'',
   '{"canvas":{"w":1000,"h":1600},"slots":[
  ...
  ('photo-caption-back','포토 캡션 후면','paper','back','documentary_photo',4,'photo',
  ...
  ('gallery-qr-back','갤러리 QR 후면','paper','back','modern_digital',5,'extension_required',

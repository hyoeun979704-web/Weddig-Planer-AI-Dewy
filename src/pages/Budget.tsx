...
const Budget = () => {
  ...
  const planningStageGuide: Record<string, { text: string }> = {
    just_started: { text: "이제 시작했다면 총 예산부터 잡아보세요" },
    researching: { text: "지역 평균과 비교하며 카테고리별로 배분해보세요" },
    contracting: { text: "계약금/잔금 일정을 빠짐없이 기록해두세요" },
    wrapping_up: { text: "결제 완료 표시로 마무리하고 최종 합계를 확인해보세요" },
  };

...
const EXAMPLE_QUESTIONS = [
  { label: "웨딩홀 추천해주세요.", modal: "venue" as ModalType },
  { label: "스드메 패키지 비용은 얼마나 하나요?", modal: "sdme" as ModalType },
  { label: "우리 결혼 예산 분석 리포트 만들어주세요.", modal: "budget" as ModalType, premium: true },
  { label: "본식 당일 타임라인 만들어주세요", modal: "timeline" as ModalType },
];

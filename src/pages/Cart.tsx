                    ...
                    <div className="flex items-center justify-between">
                      ...
                      <div className="flex items-center gap-2">
                        <button
                          ...
                          className="w-7 h-7 rounded-full border border-border flex items-center justify-center hover:bg-muted active:scale-90 transition-all disabled:opacity-40 disabled:active:scale-100"
                        >
                        ...
                        <button
                          onClick={() => updateQuantity(item.id, item.quantity + 1)}
                          aria-label="수량 늘리기"
                          className="w-7 h-7 rounded-full border border-border flex items-center justify-center hover:bg-muted active:scale-90 transition-all"
                        >
                      ...
                      <div className="flex items-center gap-2">
                        ...
                        <button
                          ...
                          aria-label="상품 삭제"
                          className="p-1.5 rounded-full text-muted-foreground hover:text-destructive hover:bg-destructive/10 active:scale-90 transition-all"
                        >

      ...
      <main className="px-5 py-6 pb-24 text-[13px] leading-7 text-foreground">
        ...
        <Section title="제6조 (요금 및 결제)">
          <ol className="list-decimal pl-5 space-y-1">
            <li>회사가 제공하는 유료 서비스는 다음과 같습니다.
              <ul className="list-disc pl-5 mt-1">
                <li>Premium 구독: 월간·연간 정기 결제, AI Planner 무제한 이용 등</li>
                <li>하트 충전: 1,900원 / 4,900원 / 11,900원 / 24,900원 / 54,900원 등 패키지</li>
                <li>식전영상 외주: 건별 정액 결제 (29,900원~89,900원)</li>
              </ul>
            </li>
            <li>결제는 회사가 지정한 결제대행사(PG, 포트원 및 연동 PG)를 통해 다음의 수단으로
              이루어집니다.
              <ul className="list-disc pl-5 mt-1">
            ...
            <li>정기 결제(자동 갱신) 이용 시, 회원의 결제 정보는 결제대행사가 발급한 빌링키 형태로
              안전하게 보관되며, 회사는 카드번호·계좌번호 등 결제 수단의 원본 정보를 직접 보관하지
              않습니다.</li>
        ...
        <Section title="제8조 (Premium 구독)">
          <ol className="list-decimal pl-5 space-y-1">
            ...
            <li>Premium 구독은 회원이 해지하지 않는 한 매 결제 주기(월간 구독은 매월, 연간 구독은 매년)
              동일한 금액으로 자동 갱신됩니다. 갱신 결제는 직전 결제일에 등록된 결제 수단의 빌링키로
              처리됩니다.</li>
            <li>회사는 다음 결제 예정일 최소 7일 전에 갱신 예정 사실(결제 예정일·금액·결제 수단)을
              이메일 또는 앱 알림 등으로 회원에게 사전 고지합니다.</li>
            <li>회원은 마이페이지의 구독 관리 메뉴에서 언제든지 다음 결제일 도래 전까지 구독을 해지할 수
              있으며, 해지 시점부터 자동 갱신이 중단됩니다. 이미 결제된 구독 기간은 만료일까지 정상
              이용할 수 있습니다.</li>
            <li>갱신 결제가 결제 수단의 한도 초과·유효기간 만료 등으로 실패한 경우, 회사는 회원에게
              알리고 일정 기간 내 재시도하거나 회원의 결제 수단 변경을 안내할 수 있으며, 이 기간 내에
              결제가 완료되지 않으면 구독이 자동으로 해지됩니다.</li>
        ...
        <Section title="제9조 (환불 정책)">
          <ol className="list-decimal pl-5 space-y-1">
            ...
            <li>Premium 정기 구독의 자동 갱신 결제에 대해서는 다음 기준이 적용됩니다.
              <ul className="list-disc pl-5 mt-1">
                <li>회원이 다음 결제일 도래 전까지 구독을 해지하면 자동 갱신이 중단되며, 별도의 추가
                  결제가 발생하지 않습니다.</li>
                <li>자동 갱신 결제일로부터 7일 이내이고, 해당 갱신 주기의 유료 기능(AI Planner 등)을
                  사용하지 않았으며 갱신 시 지급된 보너스 하트를 사용하지 않은 경우 전액 환불이
                  가능합니다.</li>
                <li>위 조건을 충족하지 못하는 경우 잔여 기간에 대한 환불은 제공되지 않으며, 회원은 이미
                  결제한 구독 기간 만료일까지 계속 이용할 수 있습니다.</li>
              </ul>
            </li>

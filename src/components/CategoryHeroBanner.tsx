...
const categoryConfigs: Record<CategoryType, CategoryConfig> = {
  ...
  studios: {
    ...
    description: "스튜디오 본식·셀프 촬영 비교",
  },
  dress_shops: {
    icon: Sparkles,
    iconColor: "text-fuchsia-500",
    bgGradient: "from-fuchsia-500/10 via-fuchsia-500/5 to-background",
    accentBg: "bg-fuchsia-500/10",
    label: "드레스샵",
    title: ["나에게 어울리는", "웨딩 드레스"],
    highlight: "text-fuchsia-500",
    description: "스타일별 드레스샵 비교 & 가봉 예약",
  },
  makeup_shops: {
    icon: Sparkles,
    ...
    label: "메이크업샵",
    title: ["내 결혼식의", "베스트 컨디션"],
    highlight: "text-pink-500",
    description: "신부 메이크업 & 헤어 스타일링",
  },
  honeymoon: {
    icon: Plane,
  ...
  jewelry: {
    ...
    label: "예물예단",
    title: ["소중한 마음을 담은", "예물과 예단"],
    highlight: "text-amber-500",
    description: "결혼 반지, 예물, 예단을 한눈에 비교하세요",
  },
  appliances: {
    icon: Gift,
    ...
    label: "혼수가전",
    title: ["신혼생활의 시작,", "똑똑한 가전 선택"],
    highlight: "text-emerald-500",
    description: "TV, 냉장고, 세탁기 등 혼수 가전 비교",
  },
  suits: {
    icon: Shirt,
  ...
  invitation_venues: {
    ...
    highlight: "text-pink-500",
    description: "상견례·청첩장모임·양가식사를 위한 프라이빗 룸 식당",
  },
};

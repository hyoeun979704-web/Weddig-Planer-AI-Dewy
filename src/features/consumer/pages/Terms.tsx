  ...
  return (
    <div className="min-h-screen bg-background app-col mx-auto relative">
      ...
      <main className="px-5 py-6 pb-24 text-[13px] leading-7 text-foreground">
          ...
          <ol className="list-decimal pl-5 space-y-1">
            <li>회사가 제공하는 유료 서비스는 다음과 같습니다.
              <ul className="list-disc pl-5 mt-1">
                ...
                <li>하트 충전: 패키지별 수량·금액은 결제 화면(하트 충전 페이지)에 표시된 내용을
                  따릅니다.</li>
            ...
            <li>만 19세 미만의 미성년자가 법정대리인의 동의 없이 결제한 경우, 미성년자 본인 또는
              법정대리인은 해당 결제를 취소할 수 있습니다.</li>
          </ol>
        </Section>
        ...
        <Section title="제7조 (하트 시스템)">
          <ol className="list-decimal pl-5 space-y-1">
            <li>하트는 AI Studio 서비스 이용을 위한 충전식 토큰이며, 1 하트의 가치는 회사가 정한 환산
              기준에 따릅니다.</li>
            <li>월간·연간 Premium 구독 결제 시 회사가 정한 수량의 보너스 하트가 즉시 적립됩니다.</li>
        ...
        <Section title="제7조의2 (포인트 시스템)">
          <ol className="list-decimal pl-5 space-y-1">
            <li>포인트는 회사가 운영하는 마케팅 적립금이며, 1 포인트의 환산 가치는 0.2원입니다.</li>
            <li>신규 가입 시 1,000 포인트가 자동 적립됩니다.</li>
            <li>게임 이용, 광고 시청, 출석 체크, 이벤트 참여 등 회사가 정한 활동을 통해 추가 적립이
              가능합니다.</li>
            <li>포인트는 하트 충전 시 일부 또는 전부를 차감할 수 있으며, 상품권 교환 및 향후 제공되는
              쇼핑 카테고리에서 사용 가능합니다.</li>
            <li>포인트는 양도·매매·환금이 불가능하며, 회원 탈퇴 시 소멸됩니다.</li>
            <li>부정한 방법으로 적립·획득한 포인트는 회수될 수 있습니다.</li>
          </ol>
        </Section>

        <Section title="제8조 (Premium 구독)">
          <ol className="list-decimal pl-5 space-y-1">
            <li>Premium은 월간 또는 연간 결제를 통해 AI Planner 무제한 이용, AI 견적서·예산 분석 리포트
              PDF 생성 등 추가 기능을 제공하는 유료 서비스입니다.</li>
            <li>웹에서 결제한 구독은 자동 갱신되지 않으며, 회원이 만료일에 직접 재결제해야 이용
              기간이 연장됩니다. 앱 내 스토어 결제(Google Play·App Store)로 결제한 구독은 해지하지
              않는 한 자동 갱신되며, 각 스토어의 구독 설정에서 언제든지 해지할 수 있습니다.</li>
            <li>월간·연간 구독 결제 시 회사가 정한 수량의 보너스 하트가 지급될 수 있으며, 지급 수량 및
              조건은 결제 화면에 사전 고지됩니다.</li>
          </ol>
        </Section>
        ...
        <Section title="제9조 (환불 정책)">
          <ol className="list-decimal pl-5 space-y-1">
            <li>전자상거래 등에서의 소비자보호에 관한 법률에 따라 회원은 결제일로부터 7일 이내에
              ...
              <ul className="list-disc pl-5 mt-1">
                <li>충전 또는 Premium 구독 결제에 따라 적립된 하트의 일부 또는 전부를 사용한 경우</li>
                <li>Premium 구독 사용 기간이 경과한 경우</li>
                <li>식전영상 외주 등 회원 맞춤형 서비스가 제작에 착수된 경우</li>
                <li>기타 관련 법령에서 청약철회를 제한하는 경우</li>
              </ul>
            </li>
            <li>월간·연간 구독 결제 시 보너스 하트가 즉시 적립되며, 보너스 하트가 1개라도 사용된 경우
              해당 결제 건은 환불이 제한됩니다.</li>
        ...
        <Section title="제11조의2 (이용자 생성 콘텐츠 및 커뮤니티 운영)">
          <ol className="list-decimal pl-5 space-y-1">
            <li>회사는 커뮤니티 게시글·댓글·사진·후기 등 회원이 작성·업로드한 콘텐츠("이용자 생성
              콘텐츠")에 대하여 <span className="font-semibold">불쾌하거나 모욕적인 콘텐츠 및 악의적
              이용자에 대해 무관용 원칙(zero-tolerance)</span>을 적용합니다. 회원은 본 서비스를 이용함으로써
              이에 동의합니다.</li>
            <li>회원은 다음의 콘텐츠를 작성·게시·전송해서는 안 되며, 이를 위반한 콘텐츠는 사전 통지 없이
              삭제될 수 있습니다.
              <ul className="list-disc pl-5 mt-1">
                <li>음란·성적 수치심을 유발하는 콘텐츠</li>
                <li>욕설·비방·괴롭힘·차별·혐오 표현 등 타인을 모욕하거나 괴롭히는 콘텐츠</li>
                <li>폭력·자해·불법 행위를 조장하거나 묘사하는 콘텐츠</li>
                <li>허위 정보, 스팸, 타인의 개인정보 또는 권리를 침해하는 콘텐츠</li>
              </ul>
            </li>
            <li><span className="font-semibold">신고</span>: 회원은 부적절한 게시글·댓글을 발견한 경우 각
              콘텐츠의 신고 기능을 통해 회사에 신고할 수 있습니다.</li>
            <li><span className="font-semibold">차단</span>: 회원은 다른 이용자를 차단할 수 있으며, 차단된
              이용자의 게시글·댓글은 즉시 회원의 화면에서 보이지 않습니다.</li>
            <li><span className="font-semibold">24시간 내 조치</span>: 회사는 신고된 콘텐츠를 검토하여 본 약관을
              위반한 콘텐츠를 신고 접수 후 24시간 이내에 삭제하고, 위반 행위를 반복하거나 중대한 위반을 한
              이용자의 서비스 이용을 정지·제한하거나 퇴출(계정 이용계약 해지)할 수 있습니다.</li>
            <li>회사는 부적절한 콘텐츠의 유통을 방지하기 위해 필터링·모니터링 등 합리적인 조치를 취할 수
              있습니다.</li>
          </ol>
        </Section>
        ...
        <Section title="제12조 (회사의 의무 및 면책)">
          <ol className="list-decimal pl-5 space-y-1">
            ...
            <li>회사는 통신판매중개자로서 입점 업체와 회원 간 거래의 당사자가 아닙니다. 입점 업체가 등록한
              상품·서비스 정보 및 해당 거래(예약·결제·환불 등)에 대한 책임은 판매자인 입점 업체에게 있으며,
              회사는 거래 당사자가 아니므로 이에 대한 책임을 지지 않습니다.</li>
          </ol>
        </Section>

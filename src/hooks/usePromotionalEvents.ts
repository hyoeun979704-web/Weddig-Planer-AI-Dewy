...
const FALLBACK_BASE: PromotionalEvent[] = [
  ...
  },
  {
    ...
    slug: "review",
    title: "본식·업체 후기 작성",
    subtitle: "장소 리뷰 첫 작성 시 3,000포인트 즉시 적립",
    position: 30,
  ...
  {
    id: "fallback-family-invite",
    slug: "family_invite",
    title: "가족 초대 — 일정·예산 함께",
    subtitle: "부모님·플래너에게 권한 위임",
    position: 40,
    thumbBg: "from-[#FFF6E5] to-[#FFE1A8]",
    icon: null,
    ctaLabel: "가족 초대",
    ctaPath: "/family-invite",
    status: "live",
    startsAt: null,
    endsAt: null,
    targetPersonas: [],

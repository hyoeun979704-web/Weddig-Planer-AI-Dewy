...
export const BUSINESS_GUIDES: BusinessGuideDef[] = [
  ...
  },
  {
    ...
    slides: [
      { phase: "STEP 1", img: g2Form, alt: "상품 등록 폼", tags: ["상품명", "가격", "설명"],
        title: "상품명·가격을 입력", subtitle: "상품명과 가격(원)을 넣고\n설명·사진을 더합니다.",
        tip: "가격을 비워두면 상세 첫 화면이\n‘가격은 문의로 안내’로 보여요." },
  ...
  },
  {
    ...
    slides: [
      ...
      { phase: "이벤트", img: g4EventForm, alt: "이벤트 등록", tags: ["이벤트", "기간"],
        title: "이벤트를 등록", subtitle: "이벤트명·내용·시작/종료일을 넣어\n기간 한정 프로모션을 알립니다.",
        tip: "기간이 지나면 자동으로 내려가요." },
      { phase: "이벤트", img: g4EventBanner, alt: "이벤트 배너", tags: ["배너", "필수"],
        title: "배너 이미지는 필수", subtitle: "목록·카드에 노출될 대표 배너를 올립니다.\n상세 이미지는 선택이에요.",
        tip: "배너는 가로형이 잘 어울려요\n(눈에 띄는 한 장)." },
    ],
  },
  {

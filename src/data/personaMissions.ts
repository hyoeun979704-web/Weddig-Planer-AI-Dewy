...
const PERSONA_SPECIFIC: Partial<Record<WeddingPersonaMode, PersonaMission[]>> = {
  ...
  small_budget: [
    ...
    {
      key: "budget-priority",
      label: "꼭 쓸 항목 3가지만 추리기",
      hint: "스드메·식대·예복 중 우선순위 정리",
      emoji: "✂️",
      href: "/budget",
    },
  ],
  small_luxury: [
    ...
    {
      key: "luxury-guestcare",
      label: "소수 하객 응대 동선 설계",
      hint: "웰컴드링크·코스 식순·좌석 배치",
      emoji: "🍾",
      href: "/ai-planner",
    },
  ],
  // 만혼·디자이너 — 취향·완성도 중시. 기존엔 페르소나 미션이 없어 일반 폴백으로 새던 갭.
  designer_late: [
    {
      key: "designer-moodboard",
      label: "콘셉트 무드보드 정리",
      hint: "톤·소재·컬러 레퍼런스 한 판에",
      emoji: "🎨",
      href: "/magazine",
    },
    {
      key: "designer-signature",
      label: "시그니처 디테일 1가지 정하기",
      hint: "드레스·플라워·소품 중 포인트",
      emoji: "💎",
      href: "/ai-studio/dress-tour",
    },
  ],
  // 절약·분석형 — 데이터로 의사결정. 비교·기록 미션으로 강점 살림.
  budget_analytic: [
    {
      key: "analytic-compare",
      label: "견적 2곳 항목별 비교표 만들기",
      hint: "스드메·식대·옵션 단가까지 분해",
      emoji: "📊",
      href: "/budget",
    },
    {
      key: "analytic-track",
      label: "이번 주 지출 입력·정합 점검",
      hint: "계약금·잔금·환불까지 빠짐없이",
      emoji: "🧮",
      href: "/budget/history",
    },
  ],
  // 결혼 준비 초보 — 전체 그림부터. 큰 흐름 이해 미션.
  first_timer: [
    {
      key: "firsttimer-overview",
      label: "전체 준비 흐름 한눈에 보기",
      hint: "D-day별 무엇부터 하는지",
      emoji: "🗺️",
      href: "/my-schedule",
    },
    {
      key: "firsttimer-terms",
      label: "스드메·예단·현실예산 용어 익히기",
      hint: "AI에게 모르는 단어 바로 물어보기",
      emoji: "📚",
      href: "/ai-planner",
    },
  ],
  // 호텔 웨딩 — 격식·하객 규모. 보증인원·코스 중심.
  luxury_hotel: [
    {
      key: "hotel-guarantee",
      label: "보증인원·대관 조건 확인",
      hint: "최소 보증·주말 프리미엄 비교",
      emoji: "🏨",
      href: "/venues",
    },
    {
      key: "hotel-course",
      label: "코스 메뉴·주류 옵션 점검",
      hint: "1인 식대 + 주류 반입 정책",
      emoji: "🍽️",
      href: "/ai-planner",
    },

...
const ALLOWED_CARD_COLUMNS: Record<string, string[]> = {
  ...
  honeymoon: ["agency_name", "agency_product_url", "product_type", "product_code",
  ...
  jewelry: ["brand_name", "brand_tier", "product_url", "product_code", "product_type", "sub_category", "store_type",

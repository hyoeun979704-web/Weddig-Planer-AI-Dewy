...
| # | 역할 | 카피 |
|---|---|---|
| 1 | 표지(후킹) | **"출시 전, 딱 지금만"** — Dewy 1호 테스터 모집 🎁 |
...
| 5 | 누구나 혜택 | **[누구나]** SNS 후기 → 하트 +50 / 꽃 머지 깨고 @dewy_ai_weddig_planer 태그 인증 → **부케 20만원 할인권**(선착순 100명) 💐 |
...
- §2 수치 그대로(테스터=안드로이드 한정, 후기=SNS만 보상, 부케=선착순 100명 확정).
- 과장 금지 — "최고/1위" 류 단정 표현, **지어낸 정원 수치** 쓰지 않기.
- 링크는 README §4 UTM 규칙 부착(`utm_source=instagram`, `utm_content=cardnews`).

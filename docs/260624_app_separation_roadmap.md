...
- console(운영+마케팅)은 **나 혼자 쓰는 솔로 도구 + 주로 폰** → **모바일 우선**(2026-06-24). 기존
  "웹 전용" 가정 폐기. 출시 형태(네이티브 vs 설치형 PWA)는 미정 — 상세·근거 `260624_console_structure_analysis.md`.
  consumer·partners는 네이티브(iOS/Android) + 웹.

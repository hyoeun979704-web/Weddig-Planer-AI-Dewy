...
| 소비자 | iOS | `app.dewy` | **미출시 → 신규 제출**(2026-06-28 확정) | 연속성 부담 없음 |
...
## 10. 착수 전 확인 — ✅ 해소됨 (2026-06-28)
- **소비자 iOS = 미출시 확정** → 신규 제출, 연속성 부담 없음. **연속성 보존 대상 = 소비자 Android 1개**.
  상세 인벤토리·동결 기준: `260628_phase4_pr40_release_continuity_inventory.md`(PR 4-0).
- 그 외(모노레포·appId `app.dewy.partners`·partners=기업회원 전용·백엔드 공유·푸시) 확정.
- **남은 외부 확인(계정 소유자)**: Android keystore 백업·Play App Signing 사용 여부(인벤토리 §2).

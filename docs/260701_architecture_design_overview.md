...
>
> **자매 문서**: 데이터 현실 기반 실행 계획표는 `docs/260701_next_session_roadmap.md`(활성업체·claim·
> 후기·무드태그 실측 스냅샷 + 활성화/측정 3축). 이 문서는 **구조·설계도** 관점, 자매 문서는
> **데이터·실행 우선순위** 관점 — 상호 보완이다(둘 다 `docs/260630_competitive_upgrade_plan.md` 이월표와 연결).
>
